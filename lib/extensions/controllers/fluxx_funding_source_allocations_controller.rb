  ...
  def self.included(base)
      ...
      insta.pre do |controller_dsl|
        ...
        self.pre_models ||= if prog_entity
          if params[:spending_year].blank?
            ...
            prog_entity.funding_source_allocations(:show_unapproved => params[:show_unapproved], :spending_year => params[:spending_year], :deleted_at => nil)
          end
        else
          []
        end
    ...
    base.insta_post FundingSourceAllocation do |insta|
      ...
      insta.pre do |config|
        ...
        fsa_query = FundingSourceAllocation.where(:spending_year => cur_params[:spending_year], :funding_source_id => cur_params[:funding_source_id], :deleted_at => nil)
