module BaseSimpleDocketReport
  def compute_document_data controller, show_object, params, report_vars, models
    ...
    query = build_request_query active_record_params, start_date, end_date, programs, sub_programs, grant_cycle
    requests = query.all
  ...
  def build_request_query active_record_params, start_date, end_date, programs, sub_programs, grant_cycle
