  ...
  class Engine < Rails::Engine
    ...
    initializer 'fluxx_engine.add_compass_hooks', :after=> :disable_dependency_loading do |app|
      ...
      begin
        ...
        defaults.alerts = [['New Report Alert', RequestReportsController.name], ['New Requests Alert', GrantRequestsController.name], ['New Grants Alert', GrantedRequestsController.name]]
